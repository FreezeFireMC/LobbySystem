...
public class LobbyInventorys {
    public static void setLobbyInventory(Player player) {
        ...
        menu.additem(16, new ItemBuilder(Material.GRASS_BLOCK).name("§6FreeBuild").itemStack(), player1 -> {
        ...
        menu.additem(28, new ItemBuilder(Material.SNOWBALL).name("§6FreezeFight").itemStack(), player1 -> {
    ...
    public static void setMainCosmeticInventory(Player player) {
        ...
        menu.addSubmenu(15, new ItemBuilder(Material.PLAYER_HEAD, 1 ,3).skullOwner(player.getName()).name("§6Köpfe").itemStack(), getHeadMenu(player));
        menu.openInventory(player);
    }
    ...
    public static Menu getArmourMenu() {
        ...
        menu.additem(5, new ItemBuilder(Material.GOLDEN_HELMET).name("§6Gold Helm").unbreakable(true).itemStack(), player -> player.getInventory().setHelmet(new ItemBuilder(Material.GOLDEN_HELMET).name("§6Gold Helm").unbreakable(true).itemStack()));
    ...
    public static Menu getHeadMenu(Player invplayer) {
        ...
        menu.additem(10, new ItemBuilder(Material.PLAYER_HEAD, 1, 3).skullOwner("GommeHD").name("§6GommeHD´s Kopd").itemStack(), player -> {
                    player.getInventory().setHelmet(new ItemBuilder(Material.PLAYER_HEAD, 1, 3).skullOwner("GommeHD").name("§6GommeHD´s Kopd").itemStack());
            player.sendMessage(AbstractMessages.normalMessage("Dein Kopf wurde geändert!"));
                });

        menu.additem(11, new ItemBuilder(Material.PLAYER_HEAD, 1, 3).name("§6BastiGHG´s Kopf").skullOwner("BastiGHG").itemStack(), player -> {
            player.getInventory().setHelmet(new ItemBuilder(Material.PLAYER_HEAD, 1, 3).name("§6BastiGHG´s Kopf").skullOwner("BastiGHG").itemStack());
            player.sendMessage(AbstractMessages.normalMessage("Dein Kopf wurde geändert!"));
        });
        menu.additem(12, new ItemBuilder(Material.PLAYER_HEAD, 1, 3).name("§6thejocraft´s Kopf").skullOwner("thejocraft").itemStack(), player -> {
            player.getInventory().setHelmet(new ItemBuilder(Material.PLAYER_HEAD, 1, 3).name("§6thejocraft´s Kopf").skullOwner("thejocraft").itemStack());
            player.sendMessage(AbstractMessages.normalMessage("Dein Kopf wurde geändert!"));
        });
        menu.additem(13, new ItemBuilder(Material.PLAYER_HEAD ,1 ,3).name("§6RedSlxzer´s Kopf").skullOwner("RedSlxzer").itemStack(), player -> {
            if (player.hasPermission(String.valueOf(Permissions.VIPPERMISSIONS))) {
                player.getInventory().setHelmet(new ItemBuilder(Material.PLAYER_HEAD ,1 ,3).name("§6RedSlxzer´s Kopf").skullOwner("RedSlxzer").itemStack());
                player.sendMessage(AbstractMessages.normalMessage("Dein Kopf wurde geändert!"));
            } else {
                PlayerLanguage playerLanguage = ServerAPIBukkitMain.getOnlinePlayers().get(player.getUniqueId());
        ...
        menu.additem(14, new ItemBuilder(Material.PLAYER_HEAD ,1 ,3).name("§6 " + invplayer.getName() + "´s Kopf").skullOwner(invplayer.getName()).itemStack(), player -> {
            if (player.hasPermission(String.valueOf(Permissions.VIPPERMISSIONS))) {
                player.getInventory().setHelmet(new ItemBuilder(Material.PLAYER_HEAD ,1 ,3).name("§6 " + invplayer.getName() + "´s Kopf").skullOwner(invplayer.getName()).itemStack());
                player.sendMessage(AbstractMessages.normalMessage("Dein Kopf wurde geändert!"));
            } else {
                PlayerLanguage playerLanguage = ServerAPIBukkitMain.getOnlinePlayers().get(player.getUniqueId());
                player.sendMessage(playerLanguage.getNOPERMISSION());
        ...
        menu.additem(16, new ItemBuilder(Material.PLAYER_HEAD ,1 ,3).name("§6ChaosNeko´s Kopf").skullOwner("ChaosNeko").itemStack(), player -> {
            if (player.hasPermission(String.valueOf(Permissions.VIPPERMISSIONS))) {
                player.getInventory().setHelmet(new ItemBuilder(Material.PLAYER_HEAD ,1 ,3).name("§6ChaosNeko´s Kopf").skullOwner("ChaosNeko").itemStack());
                player.sendMessage(AbstractMessages.normalMessage("Dein Kopf wurde geändert!"));
            } else {
                PlayerLanguage playerLanguage = ServerAPIBukkitMain.getOnlinePlayers().get(player.getUniqueId());
                player.sendMessage(playerLanguage.getNOPERMISSION());
