package de.chaos.mc.lobbysystem.utils.invsortings.mlgrushinventorysorting.ormlite;
...
public class UpdateMLGRushInvSortingRepository implements UpdateMLGRushInventorySortingInterface {
    ...
    if (inventory.getItem(8) != null) {
        ...
        MLGRushInventoryDAO MLGRushInventoryDAO = de.chaos.mc.lobbysystem.utils.invsortings.mlgrushinventorysorting.ormlite.MLGRushInventoryDAO.builder()
